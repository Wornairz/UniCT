...
int matrix_chain_order(Matrice * p, int n) {
    ...
    for(int l=2; l<=n; l++) { // lunghezza della catena, da 2 fino ad n matrici
        for(int i=0; i<=n-l; i++) { //indice sinistro, indica da quale matrice stiamo partendo - nella condizione della i va bene sia i<=n-l che i<n-l+1 usata libro
